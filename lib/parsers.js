...
/**
 * Parse a multi-record readable text stream.
 * @param ins       A readable stream containing text content.
 * @param process   A process function, called once per line of text in the
 *                  input stream.
 * @param separator The character used to separate records, for example
 *                  newline or 0x0.
 */
function recordParser( ins, process, separator ) {
...
function lineParser( ins, process ) {
    return recordParser( ins, process, NEWLINE ) {
}

module.exports = { recordParser, lineParser };
